    ...
    >
      <div className="relative z-10 flex h-full w-full max-w-360 flex-col border-x border-amber-900/10">
        ...
        <div className="shrink-0 border-t border-stone-800/40 bg-black/30">
          <div className="flex items-center gap-3 border-b border-stone-800/20 px-6 py-1.5">
            <span className="font-mono text-[9px] tracking-widest text-stone-700 uppercase">
              Agent Pipeline
            </span>
          </div>
          <AgentPipeline />
            ...
            >
              <div className="flex items-center justify-between border-b border-stone-800/40 px-6 py-2">
                <div className="flex items-center gap-2">
                  ...
                  {!isRunning && (
                    <span className="rounded bg-amber-950/50 px-1.5 py-0.5 font-mono text-[9px] text-amber-600">
                      complete
                    </span>
                  )}
                </div>
